...
export default class SummaryObject {
  /**
   ...
   */
  'sourceStatus'?: SummaryObjectSourceStatusEnum;
  ...
  static readonly attributeTypeMap: Array<AttributeType> = [
    ...
    },
    {
      ...
      type: 'SummaryObjectSourceStatusEnum',
      format: '',
    },
  ];

  static getAttributeTypeMap(): Array<AttributeType> {
    return SummaryObject.attributeTypeMap;
  }
}

export type SummaryObjectSourceStatusEnum =
  | 'missing'
  | 'waiting'
  | 'failed'
  | 'completed'
