...
Incidents that violate the Code of Conduct are extremely damaging to api.video, and they will not be tolerated. The silver lining is that, in many cases, these incidents present a chance for the offenders, and the teams at large, to grow, learn, and become better. 
...
- Depending on the severity/details of the incident, removing a harasser from membership of api.video organisation
...
From both [Golang](https://golang.org/conduct) and the [Golang UK Conference](http://golanguk.com/conduct/).
